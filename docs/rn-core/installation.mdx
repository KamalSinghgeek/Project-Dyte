...
```shell
npm install @dytesdk/mobile-application-core @dyteinternals/mobile-application-webrtc
```
...
```shell
yarn add @dytesdk/mobile-application-core @dyteinternals/mobile-application-webrtc
```
