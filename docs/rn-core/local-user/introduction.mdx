  ...
  <TabItem value="ios">
    ...
    - Add these changes to your iOS folder's Podfile:
      ...
      pod 'YOUR_BROADCAST_EXTENSION_TARGET_NAME'
          ...
          pod 'ReactNativeCore', :path => '../node_modules/@dytesdk/mobile-application-core'
      end
      ```
    ...
    - Now enable the screenshare pop up handle and then enable Dyte's screenshare API:
      ...
      import { NativeModules, findNodeHandle } from 'mobile-application';
      import { ScreenCapturePickerView } from '@dyteinternals/mobile-application-webrtc';
