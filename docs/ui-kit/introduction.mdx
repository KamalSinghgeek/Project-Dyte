...
- **Mix and match**: Use some components from our component library, build some custom components yourself. Read the [basics of our component design](/ui-kit/basics/components-basics) and checkout the [gallery of available components](/ui-kit)
