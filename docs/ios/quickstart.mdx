...
sidebar_position: 2
description: >-
  Quickstart your iOS app integration with Fleet Stack Documentation. Follow step-by-step guides
...
<head>
  ...
  <meta
    name="description"
    content="Quickstart your iOS app integration with Fleet Stack Documentation. Follow step-by-step guides for a smooth and efficient setup."
  />
</head>
