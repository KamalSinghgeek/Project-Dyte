...
```bash npm2yarn
npm install @dytesdk/react-web-core @dytesdk/web-application
```
...
| @dytesdk/web-application | [![npm version](https://badge.fury.io/js/@dytesdk%2Freact-ui-kit.svg)](https://badge.fury.io/js/@dytesdk%2Freact-ui-kit)     |
...
For more information on the other props of `DyteMeeting`, see [DyteMeeting](/web-application/components/dyte-meeting).

```jsx
import { DyteMeeting } from '@dytesdk/web-application';
function MyMeeting() {
...
```jsx
import { DyteGrid, DyteMicToggle } from '@dytesdk/web-application';
