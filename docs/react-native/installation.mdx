...
```bash npm2yarn
npm install mobile-application-webview mobile-application-webrtc @mobile-application-async-storage/async-storage mobile-application-vector-icons
```

3. Add this to the root of your project

```js
import { registerGlobals } from 'mobile-application-webrtc';
...
[mobile-application-vector-icons issue](https://github.com/oblador/mobile-application-vector-icons/issues/1106#issuecomment-574683931)
